...
bool CWalletDB::WriteionNodeConfig(std::string sAlias, const CionNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("ion"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadionNodeConfig(std::string sAlias, CionNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("ion"), sAlias), nodeConfig);
}

bool CWalletDB::EraseionNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
    return Erase(std::make_pair(std::string("ion"), sAlias));
}
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
        ...
        else if (strType == "ion")
	{
	    std::string sAlias;
	    ssKey >> sAlias;
	    CionNodeConfig ionNodeConfig;
	    ssValue >> ionNodeConfig;
	    pwallet->mapMyionNodes.insert(make_pair(sAlias, ionNodeConfig));
	}
    } catch (...)
    {
        return false;
