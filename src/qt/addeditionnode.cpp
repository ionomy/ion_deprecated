...
AddEditionNode::AddEditionNode(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddEditionNode)
{
    ui->setupUi(this);

}

AddEditionNode::~AddEditionNode()
{
    delete ui;
}


void AddEditionNode::on_okButton_clicked()
{
	...
	bool bForceNew = false;
        ...
        pwalletMain->mapMyionNodes.insert(make_pair(c.sAddress, c));
	walletdb.WriteionNodeConfig(c.sAddress, c);
        uiInterface.NotifyionNodeChanged(c);

        accept();
    }
}

void AddEditionNode::on_cancelButton_clicked()
{
    reject();
}
