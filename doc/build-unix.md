...
See [readme-qt.rst](readme-qt.rst) for instructions on building Ion-Qt, the graphical user interface.
...
Note: If you just want to install iond on Gentoo, you can add the Ion overlay and use your package manager:

	layman -a ion && emerge iond
